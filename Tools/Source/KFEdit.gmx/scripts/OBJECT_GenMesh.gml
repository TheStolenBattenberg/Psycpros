///OBJECT_GenMesh(obj, buffer, flags);
...
while(i < obj[5]) {
    ...
    switch(primType) {
        ...
        case $20000304:
            ...
            v1 = vOffsetPtr + (8 * buffer_read(b, buffer_u16)); //Vertex 1
            n2 = n1;
            v2 = vOffsetPtr + (8 * buffer_read(b, buffer_u16)); //Vertex 2
            n3 = n1;
            v3 = vOffsetPtr + (8 * buffer_read(b, buffer_u16)); //Vertex 3
        ...
        case $2C000709:
            ...
            v3 = vOffsetPtr + (8 * buffer_read(b, buffer_u16)); //Vertex 3
            n4 = n1;
            v4 = vOffsetPtr + (8 * buffer_read(b, buffer_u16)); //Vertex 4
